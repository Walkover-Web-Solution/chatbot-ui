        ...
        return (
            <div className="flex w-full pb-1">
                ...
                <div className="flex flex-col max-w-[90%] animate-slide-left w-full ">
                    ...
                    {message?.finish_reason === "maximum_iteration_limit_reached" && !message?.timeOut && !message?.error && (
                        <div className="p-2.5 pt-0">
                            <div className="flex items-center gap-2 text-warning bg-warning/10 rounded px-3 py-2 border border-warning/20">
                                <AlertCircle className="w-4 h-4 flex-shrink-0" />
                                <p className="text-sm">Maximum iteration limit reached.</p>
                            </div>
                        </div>
                    )}

                    <div className="flex items-center gap-2">
                        {!message?.wait && !message?.isStreaming && !message?.timeOut && !message?.error && (!planning || isPlanningCompleted) && (
