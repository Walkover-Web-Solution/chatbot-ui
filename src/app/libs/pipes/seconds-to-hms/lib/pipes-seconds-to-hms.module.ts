...
import { TimeShortNameEnum } from '@msg91/constant';

@Pipe({
    name: 'secondsToHMS',
})
export class SecondsToHMSPipe implements PipeTransform {
    private timeShortNameEnum = TimeShortNameEnum;
    ...
    transform(
        ...
        if (value) {
            ...
            return typeOfTime ? value + ' ' + this.timeShortNameEnum[typeOfTime] : `0 sec`;
        }
    }
}
