...
export const SegmentoUrls = {
    ...
    segmentoRegisterUser: (baseUrl) => createUrl(baseUrl, 'register/'),
    getTwitterIntegrationDetails: (baseUrl) => createUrl(baseUrl, 'get-cc-integration/twitter'),
    getLongCodeNumberIntegrationDetails: (baseUrl) => createUrl(baseUrl, 'get-cc-integration/numbers'),
    getTwitterUsersData: (baseUrl) => createUrl(baseUrl, 'user/'),
};
