...
export const CampaignUrls = {
    ...
    getCampaignRemainingLimit: (baseUrl) => createUrl(baseUrl, 'campaigns/:slug/getCampaignRemainingLimit'),
    ...
    getAnalytics: (baseUrl) => createUrl(baseUrl, 'campaigns/:slug/analytics'),
    ...
    getServiceDetails: (baseUrl) => createUrl(baseUrl, 'logs/:serviceName'),
    exportAnalyticsLogs: (baseUrl) => createUrl(baseUrl, 'exports/:serviceName'),
    getFailedLogs: (baseUrl) => createUrl(baseUrl, 'requestIdError'),
    getCampaignLogDetails: (baseUrl) => createUrl(baseUrl, 'campaignLogs/:logId/requestBody'),
    getConversionJourney: (baseUrl) => createUrl(baseUrl, 'campaigns/:slug/conversionJourney'),
};
