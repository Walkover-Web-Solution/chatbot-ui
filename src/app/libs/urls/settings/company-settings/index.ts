...
export const CompanySettingUrls = {
    ...
    changeCompanyUserName: (baseUrl) => createUrl(baseUrl, 'api/v5/panel/changeCompanyUserName'),
    VoiceUserRegister: (baseUrl) => createUrl(baseUrl, `register/`),
    getFormValidations: (baseUrl) => createUrl(baseUrl, 'api/v5/forms/getValidations'),
};
