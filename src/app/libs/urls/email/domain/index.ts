...
export const DomainUrls = {
    ...
    addIps: (baseUrl) => createUrl(baseUrl, 'smtp-credentials/:smtpCreId/whitelisted-cidrs'),
    removeIps: (baseUrl) => createUrl(baseUrl, 'smtp-credentials/:smtpCreId/whitelisted-cidrs/:ipId'),
};
