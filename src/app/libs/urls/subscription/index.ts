...
export const BillingUrls = {
    ...
    whatsappReports: (baseUrl) => createUrl(baseUrl, `whatsappReports`),
    exportWhatsappReports: (baseUrl) => createUrl(baseUrl, `whatsappReports/export`),
    salesReports: (baseUrl) => createUrl(baseUrl, `sales/sms`),
    exportSalesReports: (baseUrl) => createUrl(baseUrl, `sales/sms/export/`),
};
...
export const ClientUrls = {
    ...
    endSubscription: (baseUrl) => createUrl(baseUrl, 'companyPlans/endSubscription'),
    renewPlan: (baseUrl) => createUrl(baseUrl, 'renewExpSub/:companyPlanId'),
};

export const AdminPaymentLogsUrls = {
    getPaymentLogs: (baseUrl) => createUrl(baseUrl, `paymentLogs`),
    exportPaymentLogs: (baseUrl) => createUrl(baseUrl, `paymentLogs/export`),
...
export const AdminPlanUrls = {
    ...
    deletePlan: (baseUrl) => createUrl(baseUrl, `plans/:id`),
    fetchServiceCredits: (baseUrl) => createUrl(baseUrl, `getServiceCredits`),
    loadVoiceDialPlans: (baseUrl) => createUrl(baseUrl, `dialplans/`),
    getAllDialPlans: (baseUrl) => createUrl(baseUrl, 'admin-panel-dialplan/'),
    getInvisibleOTPDialPlans: (baseUrl) => createUrl(baseUrl, 'admin/getDialPlans'),
    fetchFeatureList: (baseUrl) => createUrl(baseUrl, `features`),
};
