...
export class FileUploadComponent implements OnInit, OnChanges {
    ...
    @Input() public changeFile: boolean;
    @Input() public id: string = 'file-upload';
    @Input() public uploadString: string = 'Upload CSV File';
    ...
    public ngOnChanges(changes: SimpleChanges): void {
        ...
        if (changes?.changeFile?.currentValue !== changes?.changeFile?.previousValue && this.changeFile) {
            this.startUpload();
        }
    }
    ...
    protected getFileInputElement(): HTMLInputElement {
        return document.getElementById(this.id) as HTMLInputElement;
    }

    protected setFileInput() {
