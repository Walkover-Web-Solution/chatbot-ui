...
import { BehaviorSubject, fromEvent, Subject, skip, of } from 'rxjs';
...
{
    @Input() smsTemplateFormControl: FormControl;
    ...
    public ngAfterViewInit(): void {
        fromEvent(this.smsTemplateInput.nativeElement, 'input')
            ...
            .subscribe((event: any) => {
                ...
                this.smsTemplateParams['pageNo'] = 1;
    ...
    public selectTemplate(template_id?: string): void {
        ...
        } else if (!this.smsTemplateFormControl.value) {
            this.showCloseTemplate = false;
        }
    }
    ...
    public refreshTemplate(): void {
        ...
        this.smsTemplateParams = {
            ...
            last_page: 1,
            search:
                this.smsTemplateFormControl?.value?.name ||
                (typeof this.smsTemplateFormControl.value === 'string' && this.smsTemplateFormControl.value) ||
                '',
        };
        this.fetchSmsTemplates(this.smsTemplateParams.search);
    }
