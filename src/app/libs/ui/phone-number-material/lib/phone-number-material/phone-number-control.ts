...
export class PhoneNumberControl implements ControlValueAccessor, MatFormFieldControl<PhoneNumber>, OnDestroy, OnInit {
    ...
    constructor(
        ...
        this.phoneForm = fb.group({
            countryIso2: new FormControl('', [Validators.required]),
            dial_code: new FormControl('', [Validators.pattern(DIAL_CODE_REGEX), Validators.required]),
            phonenumber: new FormControl('', [Validators.pattern(ONLY_INTEGER_REGEX)]),
        });
