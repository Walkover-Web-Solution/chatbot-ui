...
export class AuthKeyService {
    ...
    public deleteWhitelistIP(id: string, type: 'cidr' | 'ip'): Observable<BaseResponse<any, string>> {
        return this.http.post<BaseResponse<any, string>>(AuthKeyUrls.deleteWhitelistIP(this.baseUrl), { id: id, type });
    }
    ...
    public getMaskedOwnerContact(): Observable<BaseResponse<MaskedContact, any>> {
        return this.http.get<BaseResponse<MaskedContact, any>>(AuthKeyUrls.getMaskedOwnerContact(this.baseUrl));
    }

    public verifyAuthkeyPageAccess(payload: VerifyAuthKey): Observable<BaseResponse<any, any>> {
        return this.http.post<BaseResponse<any, any>>(AuthKeyUrls.verifyAuthkeyPageAccess(this.baseUrl), payload);
    }
}
