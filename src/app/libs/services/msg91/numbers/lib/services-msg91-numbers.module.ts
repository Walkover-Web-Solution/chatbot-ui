...
import {
    ...
    IAvailableLongCodeLogsResponse,
...
export class NumbersService {
    constructor(
        @Inject(ProxyBaseUrls.NumbersProxy) private numbersURL: any,
    ...
    public fetchNumbersLogs(request: any): Observable<IAvailableLongCodeLogsResponse> {
        return this.http.get<IAvailableLongCodeLogsResponse>(NumbersUrls.numbersLogs(this.reportUrl), request);
    }
}
