...
import { IIgnoreTimes } from '@msg91/models/segmento-models';
...
export class TriggerService {
    ...
    public triggersIgnoreTimes(): Observable<BaseResponse<IIgnoreTimes[], void>> {
        return this.http.get<BaseResponse<IIgnoreTimes[], void>>(TriggerUrls.getTriggersIgnoreTimes(this.baseUrl));
    }

    public validateOrModifySegment(
        phonebookId: string,
        segmentId: string,
        payload: any = {}
    ): Observable<BaseResponse<any, void>> {
        return this.http.get<BaseResponse<any, void>>(
            TriggerUrls.validateOrModifySegment(this.segmentoV1BaseUrl)
