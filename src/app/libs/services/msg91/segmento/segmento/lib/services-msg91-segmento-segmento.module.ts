...
export class SegmentoService {
    constructor(
        ...
        @Inject(ProxyBaseUrls.SubscriptionURLProxy) private subscriptionProxyUrl: any
    ) {}
    ...
    // subscription api to purchase extra credit.
    public purchaseCreditService(request: any): Observable<BaseResponse<any, any>> {
        return this.http.patch<BaseResponse<any, string>>(
            SegmentoUrls.purchaseCredits(this.subscriptionProxyUrl),
            request
        );
    }
}
