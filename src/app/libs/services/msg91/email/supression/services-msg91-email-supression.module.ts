...
export class SupressionService {
    ...
    public requestSubscribe(payload: IAsktoSubscribeReq): Observable<BaseResponse<any, any>> {
        return this.http.post<BaseResponse<any, any>>(SupressionUrls.requestSubscribe(this.emailBaseUrl), payload);
    }

    public exportSuppressionLogs(payload: any) {
        return this.http.post(SupressionUrls.exportSuppressionLogs(this.emailBaseUrl), payload);
    }
}
