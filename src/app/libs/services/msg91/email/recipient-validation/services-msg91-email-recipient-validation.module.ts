...
export class RecipientValidationService {
    constructor(
        ...
        @Inject(ProxyBaseUrls.SubscriptionURLProxy) private subscriptionURL: any
    ) {}
    ...
    public getPrepaidServiceAmount(payload: any): Observable<BaseResponse<any, any>> {
        return this.http.get<BaseResponse<any, any>>(
            RecipientValidationUrls.getPrepaidServiceAmount(this.subscriptionURL),
            payload
        );
    }

    public purchaseCredits(payload: any): Observable<BaseResponse<any, any>> {
        return this.http.patch<BaseResponse<any, any>>(
            RecipientValidationUrls.purchaseCredits(this.subscriptionURL),
            payload
        );
    }
}
