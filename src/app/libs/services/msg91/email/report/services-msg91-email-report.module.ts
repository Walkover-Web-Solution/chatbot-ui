...
import { IDayWiseData, IExtraParam, IReportsEmailStat, Reports } from '@msg91/models/email-models';
...
export class ReportsService {
    ...
    public mailReportByReportsMicroService(params: IExtraParam | IReportsEmailStat): Observable<EmailReportResponse> {
