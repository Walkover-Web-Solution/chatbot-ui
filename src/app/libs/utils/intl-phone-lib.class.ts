import { INTL_INPUT_OPTION, getIntlTelInputOption } from '@msg91/constant';
...
export class IntlPhoneLib {
    ...
    constructor(
        ...
        intlOptions: object = {},
        params: { domain: string } = { domain: 'https://control.msg91.com/app' },
        widgetData: any = null
    ) {
        const script = document.createElement('script');
        script.type = 'text/javascript';
        script.src = `${params.domain}/assets/js/intl-tel-input/intlTelInput.min.js`;
        script.onload = () => {
            // this.intl = window.intlTelInput(inputElement, { ...INTL_INPUT_OPTION, ...intlOptions });
            this.intl = window.intlTelInput(inputElement, { ...getIntlTelInputOption(widgetData), ...intlOptions });
        ...
        /**
         * issue:: OTP Widget -> Demo Credential -> Previous input Flag Change when use more than one Mobile input
         *
         */
