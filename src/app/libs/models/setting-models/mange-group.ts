...
export enum PermissionsEnums {
    ...
    VOICE_CALL_VIEW = '3-call_monitor-1',
    VOICE_CALL_MONITOR = '3-call_monitor-2',
    ...
    CAMPAIGN_CAMPAIGN_CREATE_EDIT_STOP = '6-campaign-2',
    CAMPAIGN_CAMPAIGN_LAUNCH_PLAY_PAUSE_RETRY = '6-campaign-3',
    CAMPAIGN_CAMPAIGN_DELETE = '6-campaign-4',
    ...
    GENERAL_TEAM_OPERATION = '9-team_manage-2',
    GENERAL_TEAM_NOALLOWED = '9-team_manage-0',
    GENERAL_TEAM_VIEW = '9-team_manage-1',
}
...
export enum ApiDocumentationEnums {
    ...
    SMS = 'sms/send-sms',
    RCS = 'rcs-bulk-message/rcs-bulk-template',
    OTP = 'otp/sendotp',
    WHATSAPP = 'whatsapp/send-message-in-text',
    SEGMENTO = 'segmento/createupdate-contact',
    DASHBOARD = 'overview',
    VOICE = 'voice/send-voice-sms',
...
export enum HelpDoc {
    ...
    DASHBOARD = '',
    NOTIFICATIONS = 'push-notification-and-features',
    VOICE = 'MSG91/how-to-use-voice-services',
    KNOWLEDGEBASE = 'MSG91/knowledgebase',
}
