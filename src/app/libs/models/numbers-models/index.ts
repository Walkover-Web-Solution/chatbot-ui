export interface INumberIntegrations {
    ...
    balance_exhausted_timestamp: string;
...
export interface IGetAvailableLongCodeReq {
    ...
    page_number?: number;
    longcode_number?: string;
    international_longcode?: boolean;
}

export interface IAvailableLongCodeLogsResponse {
    data: IAvailableLongCodeLogs[];
    metadata: {
        limit: number;
        offset: number;
...
export interface IAvailableLongCodeLogs {
    circle: string;
    companyId: number;
...
export interface ILongCodeNumberResModel {
    id: number;
    longcode_number: string;
    type: string;
}
