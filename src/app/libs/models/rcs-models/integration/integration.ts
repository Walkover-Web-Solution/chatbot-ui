...
export interface RegistrationData {
    ...
    status: IRcsStatus;
    rcs_use: string;
    pan_card_file_name: string | null;
    pan_card_file_format: string | null;
    gst_number_file_name: string | null;
    gst_number_file_format: string | null;
    opt_in_consent_file_format: string | null;
    opt_in_consent_file_name: string | null;
}
